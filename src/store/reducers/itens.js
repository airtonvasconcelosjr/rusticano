...
import bruto from 'assets/itens/bruto.png';
import defumado from 'assets/itens/defumado.png';
import CheeseBurguer from 'assets/itens/CheeseBurguer.png';


const initialState = [{
  titulo: 'Bruto',
  descricao: 'Pão australiano, queijo cheddar, bacon, cebola Caramelizada, maionese verde e um blend delicioso e suculento.O clássico, o Bruto!',
  foto: bruto,
  favorito: false,
  preco: 25,
  id: uuid(),
  ...
  titulo: 'Defumado',
  descricao: 'Pão de sal, queijo cheddar, blend defumado 150gr e maionese de alho.',
  foto: defumado,
  favorito: false,
  preco: 27,
  id: uuid(),
  ...
  descricao: 'Pão de abóbora, blend 150gr, queijo coalho e maionese de alho confitado',
  foto: CheeseBurguer,
  favorito: false,
  preco: 19,
  id: uuid(),
